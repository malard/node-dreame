...
import {
  ...
  type TaskLifecycle,
} from "./vacuum/lifecycle.js";
import { buildCloudPatch, type CloudRefreshResult } from "./vacuum/cloud-refresh.js";
...
export type { TaskLifecycle, BatteryLifecycle } from "./vacuum/lifecycle.js";
export type { CloudRefreshResult } from "./vacuum/cloud-refresh.js";
...
// `CloudRefreshResult` is re-exported from `./vacuum/cloud-refresh.js` above.
...
// Lifecycle event types + abort-reason mapping live in `./vacuum/lifecycle.ts`.
// The detection logic that emits them stays on `Vacuum` because it mutates
// per-instance arming state (`#battery*Armed`, `#seenAnyError`).
